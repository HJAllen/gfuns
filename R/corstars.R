...
#' @param x matrix to calculate correlations
#' @param method one of pearson or spearman
#' @param removeTriangle on of upper or lower
#' @param result on of none, html, or latex. none returns a matrix, the others format output
#' @export
